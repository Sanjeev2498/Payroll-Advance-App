...
async function showEmployeeView() {
  ...
  try {
    ...
    console.log('─'.repeat(65));
    console.log(`Email        | ${encryptionUtil.maskData(decryptedEmail, 'EMPLOYEE', 'email').padEnd(18)} | ${decryptedEmail.padEnd(18)} | ${decryptedEmail}`);
    console.log(`Phone        | ${encryptionUtil.maskData(decryptedPhone, 'EMPLOYEE', 'phone').padEnd(18)} | ${decryptedPhone.padEnd(18)} | ${decryptedPhone}`);
    console.log(`Aadhaar      | ${'●●●●-●●●●-●●●●'.padEnd(18)} | ${'●●●●●●●●●●●●'.padEnd(18)} | ${decryptedAadhaar}`);
    console.log(`PAN          | ${'●●●●●●●●●●'.padEnd(18)} | ${'●●●●●●●●●●●●'.padEnd(18)} | ${decryptedPAN}`);
    console.log(`Salary       | ${'RESTRICTED'.padEnd(18)} | ${'RESTRICTED'.padEnd(18)} | Full Access`);
    console.log('─'.repeat(65));
