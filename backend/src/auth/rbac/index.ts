...
export { ResourceAuthorizationService, ResourceAuthConfig, ResourceAuthContext, ResourceAuthConfigs } from './resource-authorization.service';
export { RbacUtilitiesService, PermissionValidationResult, DynamicPermissionRule, PermissionRuleContext } from './rbac-utilities.service';
...
export { ResourceAuthorizationGuard, CompositeAuthorizationGuard } from '../guards/resource-authorization.guard';
