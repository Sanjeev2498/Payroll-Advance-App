 ...
 */
export const ResourceAuthContext = createParamDecorator(
 ...
 */
export const UserAuthCapabilities = createParamDecorator(
  (data: unknown, ctx: ExecutionContext) => {
    const request = ctx.switchToHttp().getRequest();
 ...
 */
export const RequireUserProfileAccess = () => RequireResourceAuth({
  resourceType: 'user_profile',
  allowOwner: true,
 ...
 */
export const RequireEmployeeAccess = () => RequireResourceAuth({
 ...
 */
export const RequireAttendanceAccess = () => RequireResourceAuth({
 ...
 */
export const RequirePayrollAccess = () => RequireResourceAuth({
 ...
 */
export const RequireClientAccess = () => RequireResourceAuth({
 ...
 */
export const RequireInvoiceAccess = () => RequireResourceAuth({
